        ...
        <div id="topBar">
            <div class="flex-row just-between">
                <span class="dateRow">
                    ...
                    <input name="start_date" type="date"
                        :value="gridStore.selected.startDate.toISOString().split('T')[0]" @input="(event) => {
            ...
            <div class="flex-row just-between">
                <span class="dateRow">
                    ...
                    <input name="end_date" type="date" :value="gridStore.selected.endDate.toISOString().split('T')[0]"
                        @input="(event) => {
                            const newDate = (event.target as HTMLInputElement).valueAsDate
                            if (gridStore.selected != null && newDate != null) {
