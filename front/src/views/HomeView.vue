            ...
            <div id="panelNav">
                <div id="filterResas">
                    <form>
                        ...
                        <input id="weekNumber" type="number" min="0" max="52" v-model="filter.week" @change="filter.fetchResa" />
                ...
                <div class="toggle-pill">
                    <input type="checkbox" id="pill1" name="check" @change="isListView = !isListView"
